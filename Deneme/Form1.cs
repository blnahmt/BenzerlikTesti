            ...
            switch (selectAs)
            {
                ...
                case "ComplaintID":
                    ...
                    if (benzerlik >= rate)
                    {
                        ...
                        tempSameData.Issue2 = item2.Issue;
                        tempSameData.Company2 = item2.Company;
                        tempSameData.State2 = item2.State;
                        tempSameData.ZIPCode2 = item2.ZIPcode;
                        tempSameData.ComplaintID2 = item2.ComplaintID;
